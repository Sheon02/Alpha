  ...
  return (
    <div>
        ...
        <div className='text-sm grid gap-1'>
            ...
            {
              isAdmin(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/adminUserDisplay"} className='px-2 hover:bg-orange-200 py-1'>Users</Link>
              )
            }
            {
              isAdmin(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/orderDisplayAdmin"} className='px-2 hover:bg-orange-200 py-1'>View All Orders</Link>
              )
            }
            ...
            {
              isDelivery(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/orderDelivery"} className='px-2 hover:bg-orange-200 py-1'>Delivery</Link>
              )
            }
