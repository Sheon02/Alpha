...
const UploadProduct = () => {
  ...
  return (
    ...
    >
      ...
      {
        allSubCategory
          .filter(sub => sub.category.some(c => data.category.some(cat => cat._id === c._id))) // Filter subcategories
          .map((c, index) => (
            <option key={c._id} value={c._id}>{c.name}</option>
                ...
                <div className='grid gap-1'>
                  <label htmlFor='discount' className='font-medium'>Discount in %</label>
                  <input 
                    id='discount'
                    type='number'
                    onWheel={numberInputOnWheelPreventChange}
